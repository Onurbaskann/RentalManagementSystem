...
[RequireKiraciId]
[Route("Tenant/Panel")]
public class TenantPanelController : Controller
{
    private readonly ApplicationDbContext _db;
    private readonly ICurrentUserContext _currentUser;
    private readonly UserManager<ApplicationUser> _userManager;

    public TenantPanelController(ApplicationDbContext db, ICurrentUserContext currentUser, UserManager<ApplicationUser> userManager)
    {
        _db = db;
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var tenant = await _db.Tenants.FirstOrDefaultAsync(k => k.Id == tenantId);
        ...
        // Borç tipi dağılımı (açık charge kalemleri)
