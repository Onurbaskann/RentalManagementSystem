...
public interface ISozlesmeService
{
    ...
    Task<KiraSozlesmesi> CreateAsync(KiraSozlesmesi s);
    Task UzatAsync(int id, DateTime yeniBitis, decimal yeniKiraBedeli, bool kdvUygulanacakMi, decimal kdvOrani, decimal? tufeOrani, string? aciklama);
