...
public interface IBelgeService
{
    ...
    Task<Belge> UploadAsync(BelgeOwnerTipi ownerType, int ownerId, int belgeTuruId,
    ...
    Task<List<BelgeTuru>> GetTurlerAsync(BelgeOwnerTipi hedefEntite, bool sadeceDogru = false);
}
