    ...
    IUnitOfWork unitOfWork) : IBankTransactionService, ITransactionalService
{
    ...
    public async Task MatchAsync(MatchBankTransactionInput input)
    {
        ...
        Guard.Conflict(
            !BankMatchingPolicy.CanMatchPayment(payment.Status),
        ...
        Guard.Conflict(
            !BankMatchingPolicy.CanMatchTransaction(transaction.MatchStatus)
        ...
        Guard.Conflict(
            !BankMatchingPolicy.AreStoreAccountsCompatible(payment.StoreAccountId, transaction.StoreAccountId),
        ...
        var match = new PaymentMatch
        {
            ...
            MatchType = Models.Enums.MatchType.Manual,
        };
