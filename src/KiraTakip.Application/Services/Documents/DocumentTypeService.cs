...
namespace KiraTakip.Services.Documents;
    ...
    IUnitOfWork uow) : IDocumentTypeService
{
    ...
    public async Task UpdateAsync(int id, EditInput input)
    {
        ...
        Guard.Conflict(
            !DocumentTypeLifecyclePolicy.CanChangeActiveState(
                entity.IsSystem,
                entity.IsActive,
                input.IsActive),
            "Sistem kaydı pasif yapılamaz.");
        ...
        var targetEntity = DocumentTypeLifecyclePolicy.ResolveTargetEntity(
            entity.IsSystem,
            entity.TargetEntity,
            input.TargetEntity);
    ...
    public async Task DeleteAsync(int id)
    {
        ...
        Guard.Conflict(!DocumentTypeLifecyclePolicy.CanDelete(entity.IsSystem), "Sistem kaydı silinemez.");
