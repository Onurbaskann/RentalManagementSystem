...
namespace KiraTakip.Repositories.Charges;

public class ChargeTypeRepository(ApplicationDbContext ctx) : RepositoryBase<ChargeType>(ctx), IChargeTypeRepository
{
