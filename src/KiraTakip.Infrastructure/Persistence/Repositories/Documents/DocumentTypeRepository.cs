...
public class DocumentTypeRepository(ApplicationDbContext ctx) : RepositoryBase<DocumentType>(ctx), IDocumentTypeRepository
{
    ...
    public Task<List<DocumentType>> GetForTargetAsync(Models.Enums.DocumentOwnerType targetEntity, bool requiredOnly)
        => _dbSet
            .AsNoTracking()
