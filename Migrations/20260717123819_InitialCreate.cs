        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VarlikTipi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    VarlikId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SozlesmeIslemGecmisleri_Sozlesmeler_SozlesmeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SozlesmeTarifeler_Sozlesmeler_SozlesmeId",
                        column: x => x.SozlesmeId,
                        principalTable: "Sozlesmeler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HareketGecmisleri_OlayTipi_CreatedAt",
                table: "HareketGecmisleri",
                columns: new[] { "OlayTipi", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_HareketGecmisleri_UserId_CreatedAt",
                table: "HareketGecmisleri",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_HareketGecmisleri_VarlikTipi_VarlikId",
                table: "HareketGecmisleri",
                columns: new[] { "VarlikTipi", "VarlikId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SozlesmeIslemGecmisleri_SozlesmeId",
